...
uses Windows, Menus, Gradient, UText, StdCtrls, Classes, Controls,
  ExtCtrls, FPanel, Forms, ShellApi, messages, sysutils, UDBView,
  Dialogs, EstilColor, UDBVAux, tickprn, BringToFront;
...
type T_main = class(TForm)
    ...
    tMagVentesRelacionades: TUText;
    tEntradesRelacionadesMag: TUText;
    tArticlesACero: TUText;
    paCaixa: TFPanel;
    ...
    tAbonTornActiu: TUText;
    tObrirNouTorn: TUText;
    tReobrirTorn: TUText;
    paEntrades: TFPanel;
    tnEntrades: TUText;
    ...
    tcPressupostosRelacionats: TUText;
    tVentesRelacionada: TUText;
    tEntradesPagades: TUText;
    ...
    tArticlesRelacionatsMag: TUText;
    tNoTrobatsAArticles: TUText;
    tEliminarRegistreMag: TUText;
    tComentari: TUText;
    Mouredadesantigues1: TMenuItem;
    tnVentesB: TUText;
    tmVentesB: TUText;
    tdVentesB: TUText;
    tvVentesB: TUText;
    ...
    tClientRelacionatVentesB: TUText;
    tPressuposRelacionatVentesB: TUText;
    tAveriaRelacionadaVentesB: TUText;
    tReferenciesACaixaVentesB: TUText;
    tVentesPagadesVentesB: TUText;
    tAmbPendentVentesB: TUText;
    tVentesAbonadesVentesB: TUText;
    tAbonamentsVentesB: TUText;
    BringToFront1: TBringToFront;
    tVisites: TUText;
    UText1: TUText;
    UText2: TUText;
    UText3: TUText;
    UText4: TUText;
    Margemitjsegonsfamlies1: TMenuItem;
    tVeureAbonamentsA: TUText;
    tVeureAbonamentsB: TUText;
    procedure Sortir1Click(Sender: TObject);
    procedure Configuraci1Click(Sender: TObject);
    procedure tColumnesReact(Sender: TObject);
    procedure tFilesReact(Sender: TObject);
    procedure tMinimitzarReact(Sender: TObject);
    procedure tTancarReact(Sender: TObject);
    procedure tMosaicReact(Sender: TObject);
    ...
    procedure tMaximitzarReact(Sender: TObject);
    ...
    procedure tEntradesPagadesReact(Sender: TObject);
    procedure tArticlesRelacionatsMagReact(Sender: TObject);
    procedure tMagVentesRelacionadesReact(Sender: TObject);
    procedure tArticlesACeroReact(Sender: TObject);
    procedure tObrirNouTornReact(Sender: TObject);
    procedure tAbonTornActiuReact(Sender: TObject);
    procedure tAmbDeuteReact(Sender: TObject);
    procedure tcPressupostosRelacionatsReact(Sender: TObject);
    procedure tNoTrobatsAArticlesReact(Sender: TObject);
    procedure tEliminarRegistreMagReact(Sender: TObject);
    procedure tComentariReact(Sender: TObject);
    procedure Mouredadesantigues1Click(Sender: TObject);
    procedure taVentesBReact(Sender: TObject);
    procedure tClientRelacionatVentesBReact(Sender: TObject);
    procedure tPressuposRelacionatVentesBReact(Sender: TObject);
    procedure tAveriaRelacionadaVentesBReact(Sender: TObject);
    procedure tReferenciesACaixaVentesBReact(Sender: TObject);
    procedure tVentesPagadesVentesBReact(Sender: TObject);
    procedure tAmbPendentVentesBReact(Sender: TObject);
    procedure tVentesAbonadesVentesBReact(Sender: TObject);
    procedure tAbonamentsVentesBReact(Sender: TObject);
    procedure tVisitesReact(Sender: TObject);
    procedure Margemitjsegonsfamlies1Click(Sender: TObject);
    ...
    procedure tVeureAbonamentsAReact(Sender: TObject);
  private
          bpcWidth,
          bpcHeight,
          bpcLeft,
...
uses global, dmsrc, config, articles, marques, families, linies,
     ...
     mainaux, fastbut, llistcfg,reports,cventesA, cpressupostos,
     caveries, cventesB, centrades, carregues, mdant;
...
procedure T_main.tFilesReact(Sender: TObject);
begin
...
procedure T_main.tTancarReact(Sender: TObject);
begin
     TancarTotesLesLlistes;
end;

procedure T_main.tMosaicReact(Sender: TObject);
begin
     PosaOrdreLlistes(olMosaic);
end;

procedure T_main.tMinimitzarReact(Sender: TObject);
begin
     MinimitzaLlistes;
end;

procedure T_main.tColumnesReact(Sender: TObject);
begin
...
procedure T_main.tMaximitzarReact(Sender: TObject);
begin
...
var
     ...
     i : integer;
begin
     if _carregues.UProcessos.ProcessosActius > 0 then
     begin
          s := '';
          for i := 0 to _carregues.UProcessos.Processos.Count - 1 do
          s := s + _carregues.UProcessos.Processos[i] + #13#10;
          ...
          begin
               ...
               _carregues.UProcessos.CancelarProcessos;
          end
          else begin Action := caNone; exit; end;
     end;
...
//     SalvaOrdreColumnes;
     ...
     try
     _personals.ActualitzarRepeticions;
     except
     end;
...
begin
     ...
     if (f = _ventesA) or (f = _ventesB) then LlegendaVentes
     else
...
begin
     ...
     begin
          ...
          (fonsordres.Controls[i] <> Llistes) and
          (fonsordres.Controls[i] <> paTapa) then
          begin
...
begin
     ...
     ftoppanel.ActiveControl := sender as TWinControl;
end;
...
procedure T_main.tEntradesPagadesReact(Sender: TObject);
begin
     _entrades.Pagades1Click(nil);
end;

procedure T_main.tArticlesRelacionatsMagReact(Sender: TObject);
begin
     _magatzem.Articlerelacionats1Click(nil);
end;

procedure T_main.tMagVentesRelacionadesReact(Sender: TObject);
begin
     _magatzem.Ventesrelacionades1Click(nil);
end;

procedure T_main.tArticlesACeroReact(Sender: TObject);
begin
     _magatzem.Articlesaceroonegatiu1Click(nil);
end;

procedure T_main.tObrirNouTornReact(Sender: TObject);
begin
     _caixa.Obrirnoutorn1Click(nil);
end;

procedure T_main.tAbonTornActiuReact(Sender: TObject);
begin
     _caixa.Abonamentstornactiu1Click(nil);
end;

procedure T_main.tAmbDeuteReact(Sender: TObject);
begin
     _personals.Ambdeute1Click(nil);
end;

procedure T_main.tcPressupostosRelacionatsReact(Sender: TObject);
begin
     _articles.pressupostosrelacionats1Click(nil);
end;

procedure T_main.tNoTrobatsAArticlesReact(Sender: TObject);
begin
     _magatzem.Notrobatsaarticles1Click(nil);
end;

procedure T_main.tEliminarRegistreMagReact(Sender: TObject);
begin
     _magatzem.Eliminarregistredemagatzem1Click(nil);
end;

procedure T_main.tComentariReact(Sender: TObject);
begin
     _caixa.Comentari1Click(nil);
end;

procedure T_main.Mouredadesantigues1Click(Sender: TObject);
begin
     T_mdant.Create(Application).ShowModal;
end;

procedure T_main.taVentesBReact(Sender: TObject);
begin
     _ventesB.Abonar;
end;

procedure T_main.tClientRelacionatVentesBReact(Sender: TObject);
begin
     _ventesB.Clientrelacionat1Click(nil);
end;

procedure T_main.tPressuposRelacionatVentesBReact(Sender: TObject);
begin
     _ventesB.pressupostrelacionat1Click(nil);
end;

procedure T_main.tAveriaRelacionadaVentesBReact(Sender: TObject);
begin
     _ventesB.Averiarelacionada1Click(nil);
end;

procedure T_main.tReferenciesACaixaVentesBReact(Sender: TObject);
begin
     _ventesB.Refernciesacaixa1Click(nil);
end;

procedure T_main.tVentesPagadesVentesBReact(Sender: TObject);
begin
     _ventesB.Pagades1Click(nil);
end;

procedure T_main.tAmbPendentVentesBReact(Sender: TObject);
begin
     _ventesB.Ambpendent1Click(nil);
end;

procedure T_main.tVentesAbonadesVentesBReact(Sender: TObject);
begin
     _ventesB.Abonades1Click(nil);
end;

procedure T_main.tAbonamentsVentesBReact(Sender: TObject);
begin
     _ventesB.Abonaments1Click(nil);
end;

procedure T_main.tVisitesReact(Sender: TObject);
begin
     _averies.Visites1Click(nil);
end;

procedure T_main.Margemitjsegonsfamlies1Click(Sender: TObject);
begin
     MargeMitjaSegonsFamilia;
end;

procedure T_main.UText3React(Sender: TObject);
begin
     _ventesB.Modificacipuntual1Click(sender);
end;

procedure T_main.UText4React(Sender: TObject);
begin
     _ventesB.Feraveria1Click(sender);
end;

procedure T_main.UText1React(Sender: TObject);
begin
     _ventesA.Modificacipuntual1Click(sender);
end;

procedure T_main.UText2React(Sender: TObject);
begin
     _ventesA.Feraveria1Click(sender);
end;

procedure T_main.tVeureAbonamentsAReact(Sender: TObject);
begin
     _ventesA.Veureabonaments1Click(sender);
end;
