...
public abstract class SocketClient
{
    ...
    /**
     * Start TLS operation on an already connected socket.
     * @return
     */
    ...
    throws IOException
    {
    	...
    	InetSocketAddress isa =
    		(InetSocketAddress)this._socket_.getRemoteSocketAddress();
    	Socket s = factory.createSocket(this._socket_, isa.getHostName(),
    			isa.getPort(), true);
    	this._socket_ = s;
    }
