...
import com.lge.R3Dsample.R.raw;
...
public class GLTestRenderer implements Renderer {
    ...
    private float	mTouchMoved = 0;
    private	boolean	mRotating = true;
    ...
    private void setLeftEnv(GL10 gl) {
        ...
        gl.glMatrixMode(GL10.GL_MODELVIEW);
        gl.glLoadIdentity();
        GLU.gluLookAt(gl, - mEyeDistance, mViewHeight, 4.5f, mFocusPoint[0], mFocusPoint[1], mFocusPoint[2], 0.0f, 1.0f, 0.0f);
    }
    ...
    public	void	setTouchMove(float xpos, float viewHeight) {
    	mTouchMoved = xpos;
    	mViewHeight = viewHeight;
    }
    public	float	getTouchMove() {
    	return mTouchMoved;
    }
}
